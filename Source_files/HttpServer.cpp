...
/// @brief Tells wether or not has the request finished by checking the last 4 characters.
/// @param client_socket Target client socket.
/// @param request String in which request from client is stored.
/// @return true if current string ends with \r\n\r\n, false otherwise.
...
int HttpServer::Run()
{
    ...
    ServerSocketRun(this->server_port           ,
